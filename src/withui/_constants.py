...
_SETTINGS_HELP = {
    "Element": {
        ...
        "on_right_click": "Called the frame the element is right clicked if can_press flag is enabled",
        "on_right_release": "Called the frame the element is released from right clicking if can_press flag is enabled",
